 ...
 * needed, it starts detecting `dist/` + `bin/hub.mjs` on its own.
 */
...
test.describe('real hub', () => {
  test.skip(!hubDistExists, 'apps/hub is not built yet (no dist/ or bin/hub.mjs) -- this spec runs once workstream D ships it');
