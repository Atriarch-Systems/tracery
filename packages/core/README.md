...
```
npm install @atriarch-systems/tracery-core
```

```ts
import { validateEvent, validateBatch } from '@atriarch-systems/tracery-core';
import { Journal } from '@atriarch-systems/tracery-core';
import { buildFlows, buildFlow } from '@atriarch-systems/tracery-core';
import { assembleTrace, ancestors } from '@atriarch-systems/tracery-core';
import { project } from '@atriarch-systems/tracery-core';
import { sampleTraceEvents, buildSampleFlows } from '@atriarch-systems/tracery-core/fixtures';
import type { ActivityEvent } from '@atriarch-systems/tracery-core/contract';
```
...
```tsx
import { ActivityGraph } from '@atriarch-systems/tracery-visualizer';
...
`@atriarch-systems/tracery-core/fixtures` exports a deterministic ~40-event sample
...
```ts
import { sampleTraceEvents, sampleFlowIds, buildSampleFlows } from '@atriarch-systems/tracery-core/fixtures';
